...
'''
' Class Name: GuiAssign
' Description: A subclass of the wx Frame class. It is used by GuiStories when it is
'              in teacher mode for selecting the students that the selected template
'              will be assigned to.
'''
class GuiAssign(wx.Frame):
    ...
    '''
    ' handleShow - Function for handling an EVT_SHOW on the frame.
    '''    
    def handleShow(self, event):
        self.populateList()
    
    '''
    ' btnCancelPressed - Function for handling the pressing of the Cancel Button.
    '''    
    def btnCancelPressed(self, event):
        self.close()
    
    '''
    ' btnAssignPressed - Function for handling the pressing of the Assign Button.
    '''    
    ...
    '''
    ' populateList - Function for populating the student list.
    '''    
    ...
    '''
    ' close - Function for handling a close event on the frame.
    '''               
    ...
    '''
    ' getCheckedStudents - Helper function for determining which students are checked
    '                      in the list.
    '''    
    ...
    '''
    ' onKeyDown - Function for handling keydown events.
    '''
    ...
    '''
    ' onKeyUp - Function for handling keyup events. This one binds the escape key to
    '           the cancel button.
    '''
