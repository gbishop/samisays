...
class GuiStories(wx.Frame):
    ...
    '''
    ' lstStoriesSelected - Function that plays the title of the story when a list item 
    '                      is selected. This function is bound to the generic list 
    '                      event.
    '''
    ...
    '''
    ' lstStoriesDblClick - Function that loads the story denoted by the current list 
    '                      choice and transitions the user into story creation. This
    '                      function is bound to a double-click event on the list.
    '''
